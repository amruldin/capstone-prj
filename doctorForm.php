...
$query = "INSERT INTO `doctor`
      ...
      (`dId`, `firstName`, `lastName`, `idNumber`, `age`, `speciality1`, `speciality2`, `speciality3`, `email`, `website`, `officeName`, `district`, `street`, `city`, `villiage`, `country`, `sex`, `licNumber`, `education`, `telephone`, `cellPhone`, `emContactNumber`, `phone`, `language1`, `language2`, `language3`, `regDate`, `nationality`, `pin`) 


VALUES 


      ('$ahisId','$fName','$lName','$tazkerah','$age','$speciality1','$speciality2','$speciality3','$email','$website','$officeName','$district','$street','$city','$village', '$country','$sex','$lNumber','$education','$telephone','$cellPhone','$emTelephone','$emCellPhone','$lang1','$lang2','$lang3',NULL,'$nationality','$pin')";
...
<br>
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="ahisId" placeholder="AHIS ID" disabled value="<?php echo $ahisId ?>" name="ahisId">
    </div>
    <div class="form-group col-md-6">
